...
final class CurrencySelectionService {
    ...
    @discardableResult
    func selectPair(leftCurrencyID: UUID, rightCurrencyID: UUID) -> Bool {
        guard leftCurrencyID != rightCurrencyID else { return false }
        
        self.leftCurrencyID = leftCurrencyID
        self.rightCurrencyID = rightCurrencyID
