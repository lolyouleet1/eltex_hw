...
final class BotViewController: UIViewController {
    ...
    // MARK: - Coordinator
    weak var coordinator: BotViewControllerCoordinator?
...
private extension BotViewController {
    ...
    @objc func handleWalletButtonTapped() {
        coordinator?.botViewControllerDidRequestWallet(self)
    }
}
...
private extension BotViewController {
    enum Constants {
        ...
        static let botEnabledLabelText = "Allow bots to work:"
