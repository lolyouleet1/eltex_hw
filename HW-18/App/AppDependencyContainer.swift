...
final class AppDependencyContainer {
    ...
    private let p2pExchangeUseCase: P2PExchangeUseCaseProtocol
    ...
    init() {
        ...
        let p2pGateway = P2PGateway(networkService: networkService)
        let p2pDataMapper = P2PDataMapper()
        ...
        let p2pExchangeUseCase = P2PExchangeUseCase(repository: p2pRepository, wallet: wallet)
        ...
        self.p2pExchangeUseCase = p2pExchangeUseCase
    ...
    func makeBotCoordinator(navigationController: UINavigationController) -> BotCoordinator {
    ...
    func makeP2PExchangeCoordinator(navigationController: UINavigationController) -> P2PExchangeCoordinator {
        let currencyRepository = currencyRepository
        let currencyFilterService = currencyFilterService
        let currencySelectionService = CurrencySelectionService()
        ...
        let viewModel = P2PExchangeViewModel(
            exchangeUseCase: p2pExchangeUseCase,
            currencySelectionService: currencySelectionService
        )
        
        return P2PExchangeCoordinator(
            navigationController: navigationController,
            viewModel: viewModel,
            compactCurrenciesViewControllerFactory: compactCurrenciesViewControllerFactory,
            walletViewControllerFactory: walletViewControllerFactory
