...
private extension FavoritesFilterView {
    ...
    func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            favoritesSwitch.trailingAnchor.constraint(equalTo: trailingAnchor),
            favoritesSwitch.centerYAnchor.constraint(equalTo: centerYAnchor),
            
            titleLabel.trailingAnchor.constraint(lessThanOrEqualTo: favoritesSwitch.leadingAnchor, constant: -8),
