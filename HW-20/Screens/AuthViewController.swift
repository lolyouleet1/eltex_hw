...
final class AuthViewController: UIViewController {
    ...
    // MARK: - Lifecycle
    init(viewModel: AuthViewModel, logger: AppLoggerProtocol = AppLogger.authorization) {
...
private extension AuthViewController {
    @objc func handleForwardButtonTapped() {
        ...
        logger.info(Constants.authorizationNavigationRequestedMessage)
...
private extension AuthViewController {
    enum Constants {
        ...
        static let screenOpenedMessage = "The authorization screen was opened."
        static let authorizationNavigationRequestedMessage = "The authorization screen requested navigation after successful authorization."
    }
}
